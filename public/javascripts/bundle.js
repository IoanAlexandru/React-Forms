...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hello = React.createClass({displayName: "Hello",
		render: function(){
			return  React.createElement("form", {"data-toggle": "validator", role: "form"}, 
					  React.createElement("h1", null, "Informatii necesare pentru emiterea facturii fiscale"), 
					  React.createElement("p", null, "Te poti inscrie la GPeC Summit indiferent daca esti persoana juridica sau persoana fizica. Alege ce te reprezinta si completeaza datele solicitate ulterior in formular."), 
					  React.createElement("div", {className: "form-group"}, 
					    React.createElement("label", {className: "control-label"}, "Persoana fizica sau juridica?"), 
					    React.createElement("div", {className: "radio"}, 
					      React.createElement("label", null, 
					        React.createElement("input", {type: "radio", name: "tipPersoana", required: true}), 
					        "Persoana Fizica"
					      )
					    ), 
					    React.createElement("div", {className: "radio"}, 
					  ...
					  React.createElement("div", {className: "form-group"}, 
					    React.createElement("label", {className: "control-label", for: "firma"}, "Firma:"), 
					    React.createElement("input", {type: "text", className: "form-control", id: "firma", name: "firma", "data-error": "Trebuie sa introduceti numele firmei", placeholder: "Introduceti numele firmei sau companiei", required: true}), 
					    React.createElement("div", {className: "help-block with-errors"})
					  ), 
					  React.createElement("div", {className: "form-group"}, 
					    React.createElement("label", {className: "control-label", for: "adresa"}, "Adresa postala sediu social:"), 
					    React.createElement("input", {type: "text", className: "form-control", id: "adresa", name: "adresa", "data-error": "Trebuie sa introduceti adresa sediului firmei", placeholder: "Introduceti adresa sediului firmei", required: true}), 
					    React.createElement("div", {className: "help-block with-errors"})
					  ), 
					  React.createElement("div", {className: "form-group"}, 
					    React.createElement("div", {className: ""}, 
					      React.createElement("button", {type: "submit", className: "btn btn-default"}, "Trimiteti")
					    )
					  )
				    )
		}
